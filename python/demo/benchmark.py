...
async def main() -> None:
    ...
    print(f"✓ Created {test_quantity} users with ACTIVE KEKs")
    ...
    print("✓ Data encrypted/decrypted successfully")
    ...
    print(f"✓ All {test_sample} users successfully generated DEKs")
    ...
    print(f"✓ Old KEK (v{user_dek.kek_version}) can still decrypt EDEKs")
